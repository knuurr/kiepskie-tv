            ...
            <div class="collapse-content text-sm">
              <div class="steps steps-vertical">
                ...
                <div class="step step-primary">
                  Poczekaj aż sie przeprocesują
                </div>
                <div class="step step-primary">Profit</div>
              </div>
              <div id="video-container" class="mt-4">
                <video src={DATA.EXAMPLE_URL} controls class="rounded-lg"
                ></video>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <label class="form-control w-full">
                ...
                <div class="label flex flex-col items-start gap-1">
                  ...
                  >
                  <span class="label-text-alt text-gray-400"
                    >Twoje pliki nigdzie nie są wysyłane - <span
                      class="font-bold">obróbka jest offline</span
                    >.</span
                  >
                </div>
              </label>
                      ...
                      <div class="card bg-base-100">
                        <div class="card-body">
                          <div class="text-center text-gray-500">
                            ...
                            <p>
                              Wybierz pliki aby zobaczyć podgląd i ustawienia
                            </p>
                          </div>
                        </div>
                      </div>
